...
categorical_variables = ['agency_name','violation_code']#,'violation_street_name',
...
#lr = LogisticRegression(C=1,penalty='l1',random_state=5100)
#auc_cross = cross_val_score(lr,train,train_merged.compliance,cv =5,scoring = 'roc_auc') 
lr = LogisticRegression(random_state = 5100)

param = {'C':[0.001,0.01,0.1,1,10,100,1000], 'penalty' : ['l1','l2']}
lr_gridsearch = GridSearchCV(lr,param_grid=param, cv =3, scoring = 'roc_auc')
